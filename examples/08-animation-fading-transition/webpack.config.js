...
// We'll use CopyWebpackPlugin to copy static resources to the build folder.
...
var config = {
  ...
  module: {
    rules: [
      {
        // Run all JS files through ESLint before transpiling, bundling, etc.
        test: /\.(js)$/,
        enforce: 'pre',
        use: {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin(
      // Copy static resources to the output folder so that they can be hosted
      // along with the app by the webback-dev-server.
