...
// -------------------------------------------------------------------- //
// Wrapper classes for actual pxScene objects.
// -------------------------------------------------------------------- //
 ...
 * that it represents.
 */
class pxImage9 extends pxObject {
  constructor(props) {
    super(props);
    this.props.t = 'image9';
  }
 ...
 * that it represents.
 */
class pxWayland extends pxObject {
  constructor(props) {
    super(props);
...
// build time.
var ALIGN_HORIZONTAL = { LEFT: 0, CENTER: 1, RIGHT: 2 };
var ALIGN_VERTICAL = { TOP: 0, CENTER: 1, BOTTOM: 2 };
var ANIMATION = {
  STATUS_ENDED: 3,
  STATUS_CANCELLED: 2,
  STATUS_INPROGRESS: 1,
...
var STRETCH = { NONE: 0, STRETCH: 1, REPEAT: 2 };
var TRUNCATION = { NONE: 0, TRUNCATE: 1, TRUNCATE_AT_WORD: 2 };
...
module.exports.getSceneInfo = getSceneInfo;
module.exports.getSceneWidth = getSceneWidth;
module.exports.getSceneHeight = getSceneHeight;
module.exports.ALIGN_HORIZONTAL = ALIGN_HORIZONTAL;
module.exports.ALIGN_VERTICAL = ALIGN_VERTICAL;
module.exports.ANIMATION = ANIMATION;
module.exports.STRETCH = STRETCH;
module.exports.TRUNCATION = TRUNCATION;
...
module.exports.pxImage9 = pxImage9;
module.exports.pxWayland = pxWayland;
